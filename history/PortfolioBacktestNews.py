...
def before_trading_start(context, data):
    ...
    feed = context.model.build_feed_dict(batch_F=batch_f.values,
                                         ...
                                         initial_output=current_rnn_output, tao=3.0)
    ...
    target_return = 1 if index_current_return < 1 else context.target_profit_multiplier * index_current_return
...
if __name__ == '__main__':
    back_test_name = 'news_price_index_sortino_stop_loss_big_tao'
